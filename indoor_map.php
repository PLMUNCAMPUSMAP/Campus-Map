...
<div id="map"></div>
        ...
        <button type="button" class="popover-btn" id="toggleBtn">
            <img src="profile.png" alt="Profile" style="color: #333;">
        </button>
    ...
    <?php if(isset($_SESSION['username'])): ?>
        <p>Logged in as:</p>
        <p class="username"><strong><?php echo htmlspecialchars($_SESSION['username']); ?></strong></p>
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    document.addEventListener("click", function(event) {
        if (!profilePopover.contains(event.target) && event.target !== toggleBtn && !toggleBtn.contains(event.target)) {
            profilePopover.style.display = "none";
        }
    });
});
...
addLabel([700, 1010], "MABINI", "Mabini Building", true);
addLabel([390, 990], "BONIFACIO", "Bonifacio Building", true);
addLabel([155, 975], "DEL PILAR", "Del Pilar Building", true);
addLabel([270, 245], "RIZAL", "Rizal Building", true);
